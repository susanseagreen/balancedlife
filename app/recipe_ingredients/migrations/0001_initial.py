    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_type', models.CharField(blank=True, choices=[('', ''), ('g', 'grams'), ('kg', 'kilograms'), ('dp', 'dash/pinch'), ('tsp', 'teaspoons'), ('tbsp', 'tablespoons'), ('c', 'cups'), ('l', 'litres')], default='', max_length=5, null=True)),
